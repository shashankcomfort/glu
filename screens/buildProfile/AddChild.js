...
import {post, get} from "../../utils/ApiCalls";
  ...
  useEffect(() => {
    if (validationResponse !== true) {
      ...
      post(url, JSON.stringify(body), header).then(
        (onAddChildDetailResponse) => {
          console.log(onAddChildDetailResponse);
          console.log(userType);
          if (onAddChildDetailResponse.success) {
            setFirstName("");
            setLastName("");
            setEmail("");
            setPhone("");
            ...
            Alert.alert("Message", onAddChildDetailResponse.message);
